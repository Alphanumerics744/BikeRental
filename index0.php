<!DOCTYPE html>
<!--
	Brought to You By Code-Projects. Log On To www.sample.org for more free projects.
-->
<html lang="en">
	<head>
		<meta charset="UTF-8">
	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				...
				<p>Quick Search <br> Online Bookings <br> Pay Online <br> Hassle Free Bus Booking<br>Brought To You By sample.org</p>
				<ul class="actions">
					<li>
					...
					<div class="row">
						<section class="4u 6u(medium) 12u$(small)">
							...
							<ul class="alt">
								...
								<li><a href="https://sample.org/">Code-Projects</a> </li>
							</ul>
						</section>
						<section class="4u 6u$(medium) 12u$(small)">
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								<li>
									<h3>Address</h3>
									ABC Road<br>
									<a href="https://sample.org/">Code-Projects</a> 521126
								</li>
								<li>
									<h3>Mail</h3>
					...
					<ul class="copyright">
						<li>&copy; 2017 BookMyBusTicket. All rights reserved. Brought To You By <a href="https://sample.org/">Code-Projects</a></li>
